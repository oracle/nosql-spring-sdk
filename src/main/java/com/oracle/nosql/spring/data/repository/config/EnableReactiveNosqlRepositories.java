...
@Documented
@Inherited
@Import(ReactiveNosqlRepositoriesRegistrar.class)
public @interface EnableReactiveNosqlRepositories {
    ...
    Class<?> repositoryFactoryBeanClass() default ReactiveNosqlRepositoryFactoryBean.class;
